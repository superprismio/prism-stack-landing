    ...
    >
      <div className="max-w-4xl mx-auto py-32 px-6 text-center">
        ...
        <p className="text-muted-foreground text-lg mb-6">
          As AI agents become more common, the challenge is no longer just
        ...
        <p className="text-foreground text-lg mb-6">
          Communities need systems that preserve context across meetings,
          threads, docs, and turnover. AI is only useful at the group level if
          shared context remains durable and governable.
        </p>
        <p className="text-muted-foreground text-lg mb-6">
        ...
        <p className="text-muted-foreground text-lg">
          Prism Stack is a practical starting point for{" "}
