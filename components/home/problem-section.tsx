        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <p className="text-muted-foreground mb-6">
              ...
              <strong className="text-foreground">communities</strong>:
            </p>
            <ul className="space-y-2 text-muted-foreground mb-6">
              <li>• Discord-native communities</li>
              <li>• open source communities</li>
              <li>• research collectives</li>
              <li>• contributor networks and DAOs</li>
              <li>• distributed teams and agencies</li>
            </ul>
            <p className="text-muted-foreground mb-4">
              These teams struggle to maintain{" "}
              <strong className="text-foreground">shared context</strong> across
              conversations, meetings, documents, repositories, and AI agents.
            </p>
            <p className="text-foreground">
              Prism Stack gives communities a practical way to{" "}
              <strong>
                capture, organize, and use that context with AI in the loop.
              </strong>
            </p>
          </div>
        </div>
