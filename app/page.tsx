...
import { StackComponentsSection } from "@/components/home/stack-components-section";
    ...
    <div id="top" className="flex-1 w-full flex flex-col">
      ...
      <div className="relative overflow-hidden isolate">
        <Image
          ...
          src={chromaOrb}
          fill
          className="-z-10 pointer-events-none object-cover object-center opacity-50"
          aria-hidden="true"
        />
        <ThesisSection />
        <ContactSection />
